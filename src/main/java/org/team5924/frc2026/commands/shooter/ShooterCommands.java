...
public class ShooterCommands {
  ...
  public static ShooterState determineStateFromPosition() {
    ...
    boolean isFlipped = DriverStation.getAlliance().isPresent() && DriverStation.getAlliance().get().equals(Alliance.Red);
  ...
  public static Command autoSetState(SuperShooter shooter) {
    return Commands.run(
      () -> shooter.setGoalState(determineStateFromPosition()),
      shooter
    );
  }
}
