...
public class ClimbIOTalonFX climbTalon {
     {

  private static final int climbRId = Constants.Climb.CLIMB_R_CAN_ID;
  private static final int climbLId = Constants.Climb.CLIMB_L_CAN_ID;
  private static final String bus = Constants.Climb.BUS;
  private static final double reduction = Constants.Climb.REDUCTION;
  ...
  public ClimbIOTalonFX() {
    ClimbIOTalonFX = new TalonFX(Constants.Climb.CLIMB_L_CAN_ID, new CANBus(Constants.Climb.BUS));
    climbTalon = new TalonFX(Constants.Climb.CLIMB_R_CAN_ID, new CANBus(Constants.Climb.BUS));
    climbTalon.getConfigurator().apply(Constants.Climb.CLIMB_CONFIG);
