...
public class TurretIOTalonFX implements TurretIO {
  ...
  public TurretIOTalonFX() {
    turretTalon = new TalonFX(Constants.Turret.TURRET_CAN_ID, new CANBus(Constants.Turret.BUS));
    turretTalon.getConfigurator().apply(Constants.Turret.TURRET_CONFIG);
